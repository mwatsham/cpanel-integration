...
| Files | [capabilities/files.md](capabilities/files.md) | Account file content, directory operations, permissions, compression/extraction, uploads, and trash cleanup |
